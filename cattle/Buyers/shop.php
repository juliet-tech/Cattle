    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Smart Farm </a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total Price Ordered: Ksh; <?php echo $total; ?> </b></a>
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our Cattles stocks, Shop now!</h3></center>
        </div>
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Sellers/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					
					<img src='../Sellers/item_images/".$query2['item_image']."' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2021 Smart Cattle Management System| All Rights Reserved  |  <a style="color: #fff" target="_blank">Design by : Violet Mumbi</a>
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
							...
							<div class="form-group">
                                ...
                                <input class="form-control" placeholder="Phone" name="user_phone" type="text" value="<?php  echo $user_phone; ?>" required>
