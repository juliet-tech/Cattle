...
<?php
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			$stmt->bindParam(':item_old',$item_old);
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	?>
			 <div class="alert alert-info">
                          ...
                          <center> <h3><strong>Update Cattles</strong> </h3></center>
    ...
    <tr>
	 ...
	 <tr>
        ...
        <td><input id="inputprice" class="form-control" type="number" name="item_price" value="<?php echo $item_price; ?>" required /></td>
    </tr>

    <tr>
    	<td><label class="control-label">Weight.</label></td>
        <td><input id="inputW" class="form-control" type="number" name="item_weight" value="<?php echo $item_weight; ?>" required /></td>
    </tr>

    <tr>
    	<td><label class="control-label">Old.</label></td>
        <td><input id="inputO" class="form-control" type="number" name="item_old" value="<?php echo $item_old; ?>" required /></td>
    </tr>

    <tr>
    	<td><label class="control-label">Description.</label></td>
        <td><input id="inputD" class="form-control" type="text" name="item_desc" value="<?php echo $item_desc; ?>" required /></td>
    </tr>
