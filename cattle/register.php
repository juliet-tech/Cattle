...
$saveaccount="insert into users (user_email,user_password,user_firstname,user_lastname,user_address,user_phone) VALUE ('$user_email','$hashPassword','$user_firstname','$user_lastname','$user_address','$user_phone')";
